...
class TrelloBoardComparerTests(unittest.TestCase):
    ...
    def board_compare_test(self, compared_board_id, expected_board_id,
        ...
        compare_result = self._board_comparer.start_compare(compared_board_id,
                                                            expected_board_id)
    ...
    def test_compare_equal_boards(self):
        self.assertEqual(
            ...
            self._board_comparer.start_compare("Z8ZkJYlR", "2mhoAmxb").type)
    ...
    def test_compare_equal_boards_without_cards(self):
        self.assertEqual(
            CompareResultType.SUCCESS,
            self._board_comparer.start_compare("rK9EgGYp", "E4ew5UjV").type)
